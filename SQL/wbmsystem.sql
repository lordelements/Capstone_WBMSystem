...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2023 at 02:19 AM
...
(1000001, 'Chairman', 'Desmond', 'Fritz', 'Bane', 'Male', '2000-12-07', 'Single', '66-68 Zone 1', '../images/Desmond Fritz Bane/id123.png', '09369852147', '4', '2020', 0);
...
(1135363, 'Blackmail', 'Zone 1 Bulan Sorsogon', 'John Smith', 'Juan Dela Cruz', 'Pedro Cruz', 'Tony Lim', 'Based on the story of the witnesses, Mr. Dela Cruz is threatening Mr. Smith due to property problems.', '2022-12-17T18:01', 0);
...
(202200011, 'Menchie', 'Frederico', 'Jose', 'Female', '1993-03-21', 'Single', '411 Zone 1 Bulan Sorsogon', '../images/Santos Cruz Jose/id123.png', '09121456987', 0),
(202200012, 'Adamir', 'Cruz', 'Juanito', 'Male', '1991-03-25', 'Single', '134 Zone 1 Bulan Sorsogon', '../images/Santos Cruz Jose/id123.png', '09327456987', 0);
...
--
ALTER TABLE `officials`
  MODIFY `officialid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000002;
...
--
ALTER TABLE `residents`
  MODIFY `residentid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202200013;
COMMIT;
